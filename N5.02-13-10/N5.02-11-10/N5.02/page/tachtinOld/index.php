...
<div id="main">
    ...
    <div id="left">
        ...
        <div class="btns">
            <span id="read" class="btn">Tách tin</span>
        </div>
    ...
    <script type="text/javascript">
        ...
        function read() {
            ...
            if (!img.src) {
                ...
                alert("Vui lòng chọn ảnh."); // Thông báo alert thay vì hiển thị lỗi trên trang
                return;
            }
            ...
            if (img.naturalWidth === 0 || img.naturalHeight === 0) {
                alert("Ảnh chưa được tải lên. Vui lòng thử lại.");
                return;
            }
            ...
            try {
                ...
                console.error("Lỗi khi giải mã ảnh:", error);
                alert("Không thể giải mã ảnh. Vui lòng đảm bảo ảnh đã được chọn đúng.");
                return;
            }
